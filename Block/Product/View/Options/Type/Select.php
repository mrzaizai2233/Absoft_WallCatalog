<?php
namespace Absoft\WallCatalog\Block\Product\View\Options\Type;
...
class Select extends \Magento\Catalog\Block\Product\View\Options\Type\Select {
    ...
    public function getTitleOptionConfig(){
        return $this->_wallcatalogHelper->getOptionSelectConfig('title_option');
    }

    public function getLinkToPage(){
        return $this->_wallcatalogHelper->getOptionSelectConfig('link_to_page');
